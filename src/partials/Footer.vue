                ...
                <div class="flex flex-wrap flex-row lg:justify-between -mx-3">
                    <div class="flex-shrink max-w-full w-full lg:w-2/5 px-3 lg:pr-16">
                        <div class="flex items-center mb-2">
                            <span class="text-3xl leading-normal mb-2 font-bold text-gray-800 mt-2">NetBuzz</span>
                            <!-- <img src="./assets/img-min/logo.png" alt="LOGO"> -->
                        </div>
                    ...
                    <div class="flex-shrink max-w-full w-full lg:w-3/5 px-3">
                        <div class="flex flex-wrap flex-row">
                            <div class="flex-shrink max-w-full w-1/2 md:w-1/3 mb-6 lg:mb-0">
                                ...
                                <ul>
                                    <li class="py-1 hover:text-gray-900"><a href="#">Documentation</a>
                                    </li>
                                    <li class="py-1 hover:text-gray-900"><a href="#">Components</a>
                                    </li>
                                    <li class="py-1 hover:text-gray-900"><a href="#">Credits</a></li>
                                    <li class="py-1 hover:text-gray-900"><a href="#">Changelog</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="flex-shrink max-w-full w-1/2 md:w-1/3 mb-6 lg:mb-0">
