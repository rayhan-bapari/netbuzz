        ...
        <div class="container xl:max-w-6xl mx-auto px-4">
            ...
            <div class="flex flex-wrap flex-row -mx-4 justify-center">
                <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                    <div class="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp"
                        ...
                        <div class="relative overflow-hidden px-6">
                            <img src="../assets/img/dummy/avatar1.png"
                ...
                <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                    <!-- team block -->
                    <div class="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp"
                        v-wow data-wow-duration="1s" data-wow-delay=".1s">
                        <div class="relative overflow-hidden px-6">
                            <img src="../assets/img/dummy/avatar3.png"
                                class="max-w-full h-auto mx-auto rounded-full bg-gray-50 grayscale" alt="title image">
                        </div>
                        <div class="pt-6 text-center">
                ...
                <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                    <!-- team block -->
                    <div class="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp"
                        v-wow data-wow-duration="1s" data-wow-delay=".3s">
                        <div class="relative overflow-hidden px-6">
                            <img src="../assets/img/dummy/avatar2.png"
                                class="max-w-full h-auto mx-auto rounded-full bg-gray-50 grayscale" alt="title image">
                        </div>
                        <div class="pt-6 text-center">
                ...
                <div class="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                    <!-- team block -->
                    <div class="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp"
                        v-wow data-wow-duration="1s" data-wow-delay=".5s">
                        <div class="relative overflow-hidden px-6">
                            <img src="../assets/img/dummy/avatar4.png"
                                class="max-w-full h-auto mx-auto rounded-full bg-gray-50 grayscale" alt="title image">
                        </div>
                        <div class="pt-6 text-center">
