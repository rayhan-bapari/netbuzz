<template>
    ...
    <div id="portfolio" class="section relative z-0 py-12 md:py-16 bg-white">
        ...
        <div class="flex flex-wrap flex-row">
            <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" v-wow
                data-wow-duration="1s">
                <div class="relative overflow-hidden cursor-pointer mb-6">
                    <a href="./assets/img/dummy/img1.jpg" data-gallery="gallery1"
                        ...
                        <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                            src="../assets/img/dummy/img1.jpg" alt="Image Description">
                        <div
            ...
            <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" v-wow
                ...
                <div class="relative overflow-hidden cursor-pointer mb-6">
                    <a href="./assets/img/dummy/img2.jpg" data-gallery="gallery1"
                        data-glightbox="title: My title; description: This is a wider card with supporting text below as a natural lead-in to additional content"
                        class="glightbox3">
                        <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                            src="../assets/img/dummy/img2.jpg" alt="Image Description">
                        <div
                            class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
            ...
            <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" v-wow
                ...
                <div class="relative overflow-hidden cursor-pointer mb-6">
                    <a href="./assets/img/dummy/img3.jpg" data-gallery="gallery1"
                        data-glightbox="title: My title; description: This is a wider card with supporting text below as a natural lead-in to additional content"
                        class="glightbox3">
                        <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                            src="../assets/img/dummy/img3.jpg" alt="Image Description">
                        <div
                            class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
            ...
            <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" v-wow
                ...
                <div class="relative overflow-hidden cursor-pointer mb-6">
                    <a href="./assets/img/dummy/img4.jpg" data-gallery="gallery1"
                        data-glightbox="title: My title; description:  This is a wider card with supporting text below as a natural lead-in to additional content"
                        class="glightbox3">
                        <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                            src="../assets/img/dummy/img4.jpg" alt="Image Description">
                        <div
                            class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                            <h3 class="text-base leading-normal font-semibold my-1 text-white">Logo Design</h3>
                            <small class="d-block">Branding</small>
            ...
            <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" v-wow
                ...
                <div class="relative overflow-hidden cursor-pointer mb-6">
                    <a href="./assets/img/dummy/img5.jpg" data-gallery="gallery1"
                        data-glightbox="title: My title; description:  This is a wider card with supporting text below as a natural lead-in to additional content"
                        class="glightbox3">
                        <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                            src="../assets/img/dummy/img5.jpg" alt="Image Description">
                        <div
                            class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                            <h3 class="text-base leading-normal font-semibold my-1 text-white">Web Development</h3>
                            <small class="d-block">Web</small>
            ...
            <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" v-wow
                data-wow-duration="1s">
                <div class="relative overflow-hidden cursor-pointer mb-6">
                    <a href="./assets/img/dummy/img6.jpg" data-gallery="gallery1"
                        ...
                        class="glightbox3">
                        <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                            src="../assets/img/dummy/img6.jpg" alt="Image Description">
                        <div
                            class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                            <h3 class="text-base leading-normal font-semibold my-1 text-white">Graphic Design</h3>
                            <small class="d-block">Graphic</small>
            ...
            <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" v-wow
                data-wow-duration="1s" data-wow-delay=".1s">
                <div class="relative overflow-hidden cursor-pointer mb-6">
                    <a href="./assets/img/dummy/img7.jpg" data-gallery="gallery1"
                        ...
                        class="glightbox3">
                        <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                            src="../assets/img/dummy/img7.jpg" alt="Image Description">
                        <div
                            class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                            <h3 class="text-base leading-normal font-semibold my-1 text-white">Logo Design</h3>
                            <small class="d-block">Branding</small>
            ...
            <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" v-wow
                data-wow-duration="1s" data-wow-delay=".3s">
                <div class="relative overflow-hidden cursor-pointer mb-6">
                    <a href="./assets/img/dummy/img8.jpg" data-gallery="gallery1"
                        ...
                        class="glightbox3">
                        <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                            src="../assets/img/dummy/img8.jpg" alt="Image Description">
                        <div
                            class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                            <h3 class="text-base leading-normal font-semibold my-1 text-white">Web Development</h3>
                            <small class="d-block">Web</small>
            ...
            <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" v-wow
                data-wow-duration="1s" data-wow-delay=".5s">
                <div class="relative overflow-hidden cursor-pointer mb-6">
                    <a href="./assets/img/dummy/img9.jpg" data-gallery="gallery1"
                        data-glightbox="title: Graphic Design; description: This is a wider card with supporting text below as a natural lead-in to additional content"
                        class="glightbox3">
                        <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                            src="../assets/img/dummy/img9.jpg" alt="Image Description">
                        <div
                            class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                            <h3 class="text-base leading-normal font-semibold my-1 text-white">Graphic Design</h3>
                            <small class="d-block">Graphic</small>
            ...
            <figure class="flex-shrink max-w-full px-3 w-full sm:w-1/2 lg:w-1/5 group wow fadeInUp" v-wow
                data-wow-duration="1s" data-wow-delay=".7s">
                <div class="relative overflow-hidden cursor-pointer mb-6">
                    <a href="./assets/img/dummy/img10.jpg" data-gallery="gallery1"
                        ...
                        class="glightbox3">
                        <img class="block w-full h-auto transform duration-500 grayscale hover:scale-125"
                            src="../assets/img/dummy/img10.jpg" alt="Image Description">
                        <div
                            class="absolute inset-x-0 bottom-0 h-20 transition-opacity duration-500 ease-in opacity-0 group-hover:opacity-100 overflow-hidden px-4 py-2 text-gray-100 bg-black text-center">
                            <h3 class="text-base leading-normal font-semibold my-1 text-white">App Design</h3>
